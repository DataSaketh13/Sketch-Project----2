...
function updateCanvas(){
    ...
    random = quick_draw_data_set[random_number];
    document.getElementById('drawn_span').innerHTML = 'Sketch to be drawn:' + random;
}


function draw(){
    check_sketch();
    if(drawn_sketch == random){
    answer_holder = 'set';
    score = score + 1;
...
function check_sketch(){
   timer_counter = timer_counter + 1;
    document.getElementById("timespan").innerHTML = "Time:" + timer_counter;
